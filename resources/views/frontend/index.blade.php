                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <ul class="about__icons__wrap">
                                <li>
                                    <img class="light" src="{{ url('frontend') }}/assets/img/icons/xd_light.png" alt="XD">
                                    <img class="dark" src="{{ url('frontend') }}/assets/img/icons/xd.png" alt="XD">
                                </li>
                                <li>
                                    <img class="light" src="{{ url('frontend') }}/assets/img/icons/skeatch_light.png" alt="Skeatch">
                                    <img class="dark" src="{{ url('frontend') }}/assets/img/icons/skeatch.png" alt="Skeatch">
                                </li>
                                <li>
                                    <img class="light" src="{{ url('frontend') }}/assets/img/icons/illustrator_light.png" alt="Illustrator">
                                    <img class="dark" src="{{ url('frontend') }}/assets/img/icons/illustrator.png" alt="Illustrator">
                                </li>
                                <li>
                                    <img class="light" src="{{ url('frontend') }}/assets/img/icons/hotjar_light.png" alt="Hotjar">
                                    <img class="dark" src="{{ url('frontend') }}/assets/img/icons/hotjar.png" alt="Hotjar">
                                </li>
                                <li>
                                    <img class="light" src="{{ url('frontend') }}/assets/img/icons/invision_light.png" alt="Invision">
                                    <img class="dark" src="{{ url('frontend') }}/assets/img/icons/invision.png" alt="Invision">
                                </li>
                                <li>
                                    <img class="light" src="{{ url('frontend') }}/assets/img/icons/photoshop_light.png" alt="Photoshop">
                                    <img class="dark" src="{{ url('frontend') }}/assets/img/icons/photoshop.png" alt="Photoshop">
                                </li>
                                <li>
                                    <img class="light" src="{{ url('frontend') }}/assets/img/icons/figma_light.png" alt="Figma">
                                    <img class="dark" src="{{ url('frontend') }}/assets/img/icons/figma.png" alt="Figma">
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="container">
                    ...
                    <div class="row gx-0 services__active">
                        <div class="col-xl-3">
                            <div class="services__item">
                                <div class="services__thumb">
                                    <a href="services-details.html"><img src="{{ url('frontend') }}/assets/img/images/services_img01.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3">
                            <div class="services__item">
                                <div class="services__thumb">
                                    <a href="services-details.html"><img src="{{ url('frontend') }}/assets/img/images/services_img02.jpg" alt=""></a>
                                </div>
                                <div class="services__content">
                                    <div class="services__icon">
                        ...
                        <div class="col-xl-3">
                            <div class="services__item">
                                <div class="services__thumb">
                                    <a href="services-details.html"><img src="{{ url('frontend') }}/assets/img/images/services_img03.jpg" alt=""></a>
                                </div>
                                <div class="services__content">
                                    <div class="services__icon">
                        ...
                        <div class="col-xl-3">
                            <div class="services__item">
                                <div class="services__thumb">
                                    <a href="services-details.html"><img src="{{ url('frontend') }}/assets/img/images/services_img04.jpg" alt=""></a>
                                </div>
                                <div class="services__content">
                                    <div class="services__icon">
                    ...
                    <div class="row work__process__wrap">
                        ...
                        <div class="col">
                            <div class="work__process__item">
                                ...
                                <div class="work__process__icon">
                                    <img class="light" src="{{ url('frontend') }}/assets/img/icons/wp_light_icon04.png" alt="">
                                    <img class="dark" src="{{ url('frontend') }}/assets/img/icons/wp_icon04.png" alt="">
                                </div>
                                <div class="work__process__content">
                                    ...
                                    <div class="portfolio__active">
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ url('frontend') }}/assets/img/portfolio/portfolio_img01.jpg" alt="">
                                            </div>
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ url('frontend') }}/assets/img/portfolio/portfolio_img02.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ url('frontend') }}/assets/img/portfolio/portfolio_img03.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ url('frontend') }}/assets/img/portfolio/portfolio_img04.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ url('frontend') }}/assets/img/portfolio/portfolio_img05.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Web Development</span>
                                                <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ url('frontend') }}/assets/img/portfolio/portfolio_img06.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Web Development</span>
                                                <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ url('frontend') }}/assets/img/portfolio/portfolio_img07.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Web Development</span>
                                                <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                                ...
                                <div class="col">
                                    <div class="portfolio__active">
                                        ...
                                        <div class="portfolio__item">
                                            ...
                                            <div class="{{ url('frontend') }}/portfolio__overlay__content">
                                                <span>Web Design</span>
                                                <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                                                <a href="portfolio-details.html" class="link">Case Study</a>
                                            </div>
                        ...
                        <div class="col-lg-6">
                            <ul class="partner__logo__wrap">
                                ...
                                <li>
                                    ...
                                    <img class="dark" src="{{ url('frontend') }}/assets/img/icons/partner_05.png" alt="">
                                </li>
                                <li>
                ...
                <div class="container">
                    <div class="row gx-0 justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{ url('frontend') }}/assets/img/blog/blog_post_thumb01.jpg" alt=""></a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{ url('frontend') }}/assets/img/blog/blog_post_thumb02.jpg" alt=""></a>
                                    <div class="blog__post__tags">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{ url('frontend') }}/assets/img/blog/blog_post_thumb03.jpg" alt=""></a>
                                    <div class="blog__post__tags">
